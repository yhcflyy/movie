...
var _swiperapi = _interopRequireDefault(__webpack_require__(/*! ../../common/api/swiperapi.js */ 17));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
//
//
var _default = { data: function data() {return { items: [] };}, onLoad: function onLoad() {var _this = this;_swiperapi.default.getSwiperList().then(function (res) {_this.items = res;
    });
